...
int read_hook(struct cdev *dev, struct uio *uio, int ioflag) {
	...
	uprintf("OK, so this is how it is going down\n");
...
// cdp_list is the list of char devices.
...
// Loop through that list and if we have one corresponding to our device
// we hook it with our own routine.
